...
namespace Terminal.Gui {
	...
	/// <summary>
	/// ListView <see cref="View"/> renders a scrollable list of columnar data where each item can be activated to perform an action.
	/// </summary>
	/// <remarks>
	/// <para>
	...
	public class GridView : ListView {
		...
		public GridView (IList source) : this (MakeWrapper (source))
		{
		}
		...
		public GridView (IListDataSource source) : base ()
		{
			this.source = source;
			Initialize ();
		}
		...
		public GridView (Rect rect, IList source) : this (rect, MakeWrapper (source))
		{
			Initialize ();
		}
		...
		public GridView (Rect rect, IListDataSource source) : base (rect, source)
		{
			Initialize ();
		}
